...
<div class="contain">
  ...
  <br />
    <div class="fields">
     <span>
       <form:input class="inputfields" path="suppId" placeholder="Supplier ID" type="text" />
    </span>
    <br />
      <span>
       <form:input class="inputfields" path="suppName" placeholder="Suppier Name" type="text" />
    </span>
    <br />
     <span>
       <form:input class="inputfields" path="suppEmailId" placeholder="Suppier EmailId" type="text" />
    </span>
    <br />
     <span>
       <form:input class="inputfields" path="suppAddress" placeholder="Supplier Address" type="text" />
    </span>
    </div>
    <br />
    <div class="submit">
