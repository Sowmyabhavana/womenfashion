                            ...
                            <form:form method="post" action="${add}"  class="checkout" modelAttribute="shipping" >
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <form:input type="text" path="CompanyName" class="form-control" id="CompanyName" placeholder="CompanyName" />
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="company">Ship Country</label>
                                        <form:input type="text" path="shipcountry" class="form-control" id="shipcountry" placeholder="shipcountry" />
                                    </div>
                                      <div class="col-12 mb-3">
                                        <label for="company">Ship Address</label>
                                        <form:input type="text" path="shipaddress" class="form-control" id="shipaddress" placeholder="shipaddress" />
                                    </div>
                                     <div class="col-12 mb-3">
...
<!--                                     </div> -->
                                    ...
                                    <div class="col-12 mb-4">
                                        <label for="email_address">Zipcode <span>*</span></label>
                                         <form:input type="email" class="form-control" path="zipcode" id="zipcode" placeholder="zipcode" />
                                    </div>
